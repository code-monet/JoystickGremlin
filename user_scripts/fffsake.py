...
option_constant_gain = user_script.FloatVariable(
    "Constant Gain %",
...
option_ramp_gain = user_script.FloatVariable(
    "Ramp Gain %",
...
option_sine_gain = user_script.FloatVariable(
    "Sine Gain %",
...
option_square_gain = user_script.FloatVariable(
    "Square Gain %",
...
option_triangle_gain = user_script.FloatVariable(
    "Triangle Gain %",
...
option_sawtooth_up_gain = user_script.FloatVariable(
    "Sawtooth Up Gain %",
...
option_sawtooth_down_gain = user_script.FloatVariable(
    "Sawtooth Down Gain %",
...
option_spring_gain = user_script.FloatVariable(
    "Spring Gain %",
...
option_damper_gain = user_script.FloatVariable(
    "Damper Gain %",
...
option_inertia_gain = user_script.FloatVariable(
    "Inertia Gain %",
...
option_friction_gain = user_script.FloatVariable(
    "Friction Gain %",
...
option_spring_coefficient = user_script.FloatVariable(
    "Spring Coefficient %",
...
user_script.UserSetupTeardownRegistry.setup_cbs["fffsake"] = functools.partial(
    StartUp, PLUGIN_OPTIONS
)
user_script.UserSetupTeardownRegistry.teardown_cbs["fffsake"] = ShutDown
